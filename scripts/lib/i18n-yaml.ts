...
const STRING_KEY_DESCRIPTIONS: Record<string, string> = {
  ...
  'about.add_language.body':        'About view: HTML-allowed paragraph explaining the copy-and-rename flow for a brand-new locale.',
  ...
  'faq.station_text.body':         'Body paragraph for per-station localization.',
